...
const Products = () => {
  return (
    <div className='products flex justify-around'>
      <div className='products-left flex-3'>
        <div>
      ...
      <div className='products-right mt-5 flex-2'>
        <div className='hero'>
          <div class="bg-gray-50 flex items-center">
	          <section class="w-full bg-cover bg-center py-32" style={{backgroundImage: "url('https://source.unsplash.com/random')"}}>
		          <div class="container mx-auto text-center text-white">
			          <h1 class="text-5xl font-medium mb-6">Welcome to Swiss Fit Collections</h1>
